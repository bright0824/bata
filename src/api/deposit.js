...
import { ETH_BET20_Address } from "./ETH_BEP20_Address";
...
export const getBalance = async () => {
  ...
  //     `https://services.tokenview.io/vipapi/addr/b/eth/${ETHAddress}?apikey=${apiKey}`
  //   );
  //   const resBtc = await axios.get(
  //     `https://services.tokenview.io/vipapi/addr/b/btc/${BTCAddress}?apikey=${apiKey}`
  //   );
  //   const resTrx = await axios.get(
  //     `https://services.tokenview.io/vipapi/addr/b/trx/${TRCAddress}?apikey=${apiKey}`
  //   );
  //   const resUsdt = await axios.get(
  //     `https://services.tokenview.io/vipapi/usdt/addressdetail/${ETHAddress}?apikey=${apiKey}`
  //   );
  //   return {
