...
<header class="relative bg-white dark:bg-darker">
  ...
  >
    ...
    <button
      on:click={() => {
        isMobileMainMenuOpen.set(!$isMobileMainMenuOpen);
        isMobileMainMenuOpenValue = !isMobileMainMenuOpenValue;
      }}
    ...
    <!-- Mobile sub menu -->
    <MobileSubMenuDropdown {profileAvatar} />
  </div>

  <!-- Mobile Main menu -->
  {#if $isMobileMainMenuOpen}
    <Sidebar
      containerClass="border-b md:hidden dark:border-primary-darker"
